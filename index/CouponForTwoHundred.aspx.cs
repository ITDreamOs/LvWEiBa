...
public partial class index_CouponForTwoHundred : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("https://open.weixin.qq.com/connect/oauth2/authorize?appid=" + GetWeiXinInf.appid + "&redirect_uri=http://wx.lvwei8.com/index/myindex.aspx&response_type=code&scope=snsapi_base&state=123#wechat_redirect");
        ...
        if (IsPostBack)
        {
            ...
            else
            {
                ...
                {
                    Jscript.NorefLocation(this.Page, "验证码不正确！", "CouponForTwoHundred.aspx");
                }
                else
                {
                    ...
                    if (member != null)
                    {
                        ...
                        else
                        {
                            //删除缓存
                            HttpContext.Current.Cache.Remove("code" + mobile);
                            Jscript.NorefLocation(this.Page, "该手机号已经验证过！", "bindPhone.aspx");
                        }
                    }

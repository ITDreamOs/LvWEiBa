<%@ Page Language="C#" AutoEventWireup="true" CodeFile="news.aspx.cs" Inherits="index_news" %>
...
<html>
  ...
  <div class="page-group">
      ...
      <div class="page">
          ...
          <div class="content">
          <%--<div class="card">
            <div class="card-header">尊敬的超人不会飞：您好！</div>
            <div class="card-content">
              <div class="card-content-inner">欢迎入驻驴尾巴旅游网！我们将竭诚为
您旅游出行做最优质的服务。</div>
            </div>
            <div class="card-footer">2015年07月02日 18:48:58</div>
          </div>--%>
